...
def build_model(gpu, model_name, num_classes=10):
    """
...
def set_gpu(net, gpu):
    ...
    net = torch.nn.DataParallel(net, device_ids=[gpu]).cuda(gpu)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, help='checkpoint name (default last_model)')
    ...
    parser.add_argument('--gpu', type=int, help='set which gpu to use')
